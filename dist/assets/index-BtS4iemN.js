...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function Mc(){return new Vi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function Sc(){return new Vi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
	...
	`}function sg(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===ya||l===ba,u=l===Er||l===yr;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let d=e.get(o);return t===null&&(t=new La(i)),d=c?t.fromEquirectangular(o,d):t.fromCubemap(o,d),e.set(o,d),d.texture}else{if(e.has(o))return e.get(o).texture;{const d=o.image;if(c&&d&&d.height>0||u&&d&&r(d)){t===null&&(t=new La(i));const h=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,h),o.addEventListener("dispose",s),h.texture}else return null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function og(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function ag(i,e,t,n){const r={},s=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let p=0,f=_.length;p<f;p++)e.remove(_[p])}h.removeEventListener("dispose",a),delete r[h.id];const m=s.get(h);m&&(e.remove(m),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const g in h)e.update(h[g],i.ARRAY_BUFFER);const m=d.morphAttributes;for(const g in m){const _=m[g];for(let p=0,f=_.length;p<f;p++)e.update(_[p],i.ARRAY_BUFFER)}}function c(d){const h=[],m=d.index,g=d.attributes.position;let _=0;if(m!==null){const y=m.array;_=m.version;for(let x=0,b=y.length;x<b;x+=3){const P=y[x+0],L=y[x+1],R=y[x+2];h.push(P,L,L,R,R,P)}}else if(g!==void 0){const y=g.array;_=g.version;for(let x=0,b=y.length/3-1;x<b;x+=3){const P=x+0,L=x+1,R=x+2;h.push(P,L,L,R,R,P)}}else return;const p=new(Hu(h)?Yu:Xu)(h,1);p.version=_;const f=s.get(d);f&&e.remove(f),s.set(d,p)}function u(d){const h=s.get(d);if(h){const m=d.index;m!==null&&h.version<m.version&&c(d)}else c(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function lg(i,e,t,n){const r=n.isWebGL2;let s;function a(m){s=m}let o,l;function c(m){o=m.type,l=m.bytesPerElement}function u(m,g){i.drawElements(s,g,o,m*l),t.update(g,s,1)}function d(m,g,_){if(_===0)return;let p,f;if(r)p=i,f="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),f="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[f](s,g,o,m*l,_),t.update(g,s,_)}function h(m,g,_){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<_;f++)this.render(m[f]/l,g[f]);else{p.multiDrawElementsWEBGL(s,g,0,o,m,0,_);let f=0;for(let y=0;y<_;y++)f+=g[y];t.update(f,s,1)}}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=d,this.renderMultiDraw=h}function cg(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function ug(i,e){return i[0]-e[0]}function dg(i,e){return Math.abs(e[1])-Math.abs(i[1])}function hg(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,a=new gt,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,d){const h=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let z=function(){oe.dispose(),s.delete(u),u.removeEventListener("dispose",z)};var m=z;p!==void 0&&p.texture.dispose();const x=u.morphAttributes.position!==void 0,b=u.morphAttributes.normal!==void 0,P=u.morphAttributes.color!==void 0,L=u.morphAttributes.position||[],R=u.morphAttributes.normal||[],K=u.morphAttributes.color||[];let S=0;x===!0&&(S=1),b===!0&&(S=2),P===!0&&(S=3);let A=u.attributes.position.count*S,W=1;A>e.maxTextureSize&&(W=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const X=new Float32Array(A*W*4*_),oe=new ku(X,A,W,_);oe.type=ui,oe.needsUpdate=!0;const I=S*4;for(let k=0;k<_;k++){const j=L[k],Y=R[k],q=K[k],$=A*W*4*k;for(let se=0;se<j.count;se++){const ae=se*I;x===!0&&(a.fromBufferAttribute(j,se),X[$+ae+0]=a.x,X[$+ae+1]=a.y,X[$+ae+2]=a.z,X[$+ae+3]=0),b===!0&&(a.fromBufferAttribute(Y,se),X[$+ae+4]=a.x,X[$+ae+5]=a.y,X[$+ae+6]=a.z,X[$+ae+7]=0),P===!0&&(a.fromBufferAttribute(q,se),X[$+ae+8]=a.x,X[$+ae+9]=a.y,X[$+ae+10]=a.z,X[$+ae+11]=q.itemSize===4?a.w:1)}}p={count:_,texture:oe,size:new Ne(A,W)},s.set(u,p),u.addEventListener("dispose",z)}let f=0;for(let x=0;x<h.length;x++)f+=h[x];const y=u.morphTargetsRelative?1:1-f;d.getUniforms().setValue(i,"morphTargetBaseInfluence",y),d.getUniforms().setValue(i,"morphTargetInfluences",h),d.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),d.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const g=h===void 0?0:h.length;let _=n[u.id];if(_===void 0||_.length!==g){_=[];for(let b=0;b<g;b++)_[b]=[b,0];n[u.id]=_}for(let b=0;b<g;b++){const P=_[b];P[0]=b,P[1]=h[b]}_.sort(dg);for(let b=0;b<8;b++)b<g&&_[b][1]?(o[b][0]=_[b][0],o[b][1]=_[b][1]):(o[b][0]=Number.MAX_SAFE_INTEGER,o[b][1]=0);o.sort(ug);const p=u.morphAttributes.position,f=u.morphAttributes.normal;let y=0;for(let b=0;b<8;b++){const P=o[b],L=P[0],R=P[1];L!==Number.MAX_SAFE_INTEGER&&R?(p&&u.getAttribute("morphTarget"+b)!==p[L]&&u.setAttribute("morphTarget"+b,p[L]),f&&u.getAttribute("morphNormal"+b)!==f[L]&&u.setAttribute("morphNormal"+b,f[L]),r[b]=R,y+=R):(p&&u.hasAttribute("morphTarget"+b)===!0&&u.deleteAttribute("morphTarget"+b),f&&u.hasAttribute("morphNormal"+b)===!0&&u.deleteAttribute("morphNormal"+b),r[b]=0)}const x=u.morphTargetsRelative?1:1-y;d.getUniforms().setValue(i,"morphTargetBaseInfluence",x),d.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function fg(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,d=e.get(l,u);if(r.get(d)!==c&&(e.update(d),r.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==c&&(h.update(),r.set(h,c))}return d}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class Ju extends pn{constructor(e,t,n,r,s,a,o,l,c,u){if(u=u!==void 0?u:zi,u!==zi&&u!==br)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===zi&&(n=ci),n===void 0&&u===br&&(n=Bi),super(null,r,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Jt,this.minFilter=l!==void 0?l:Jt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Qu=new pn,ed=new Ju(1,1);ed.compareFunction=zu;const td=new ku,nd=new Kh,id=new $u,Ec=[],yc=[],bc=new Float32Array(16),Tc=new Float32Array(9),Ac=new Float32Array(4);function Pr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Ec[r];if(s===void 0&&(s=new Float32Array(r),Ec[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function It(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Ut(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function _o(i,e){let t=yc[e];t===void 0&&(t=new Int32Array(e),yc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function pg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function mg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2fv(this.addr,e),Ut(t,e)}}function gg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(It(t,e))return;i.uniform3fv(this.addr,e),Ut(t,e)}}function _g(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4fv(this.addr,e),Ut(t,e)}}function xg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Ut(t,e)}else{if(It(t,n))return;Ac.set(n),i.uniformMatrix2fv(this.addr,!1,Ac),Ut(t,n)}}function vg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Ut(t,e)}else{if(It(t,n))return;Tc.set(n),i.uniformMatrix3fv(this.addr,!1,Tc),Ut(t,n)}}function Mg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Ut(t,e)}else{if(It(t,n))return;bc.set(n),i.uniformMatrix4fv(this.addr,!1,bc),Ut(t,n)}}function Sg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Eg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2iv(this.addr,e),Ut(t,e)}}function yg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3iv(this.addr,e),Ut(t,e)}}function bg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4iv(this.addr,e),Ut(t,e)}}function Tg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ag(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2uiv(this.addr,e),Ut(t,e)}}function wg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3uiv(this.addr,e),Ut(t,e)}}function Rg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4uiv(this.addr,e),Ut(t,e)}}function Cg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?ed:Qu;t.setTexture2D(e||s,r)}function Lg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||nd,r)}function Pg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||id,r)}function Dg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||td,r)}function Ig(i){switch(i){case 5126:return pg;case 35664:return mg;case 35665:return gg;case 35666:return _g;case 35674:return xg;case 35675:return vg;case 35676:return Mg;case 5124:case 35670:return Sg;case 35667:case 35671:return Eg;case 35668:case 35672:return yg;case 35669:case 35673:return bg;case 5125:return Tg;case 36294:return Ag;case 36295:return wg;case 36296:return Rg;case 35678:case 36198:case 36298:case 36306:case 35682:return Cg;case 35679:case 36299:case 36307:return Lg;case 35680:case 36300:case 36308:case 36293:return Pg;case 36289:case 36303:case 36311:case 36292:return Dg}}function Ug(i,e){i.uniform1fv(this.addr,e)}function Ng(i,e){const t=Pr(e,this.size,2);i.uniform2fv(this.addr,t)}function Fg(i,e){const t=Pr(e,this.size,3);i.uniform3fv(this.addr,t)}function Og(i,e){const t=Pr(e,this.size,4);i.uniform4fv(this.addr,t)}function Bg(i,e){const t=Pr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function zg(i,e){const t=Pr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Hg(i,e){const t=Pr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Gg(i,e){i.uniform1iv(this.addr,e)}function Vg(i,e){i.uniform2iv(this.addr,e)}function kg(i,e){i.uniform3iv(this.addr,e)}function Wg(i,e){i.uniform4iv(this.addr,e)}function Xg(i,e){i.uniform1uiv(this.addr,e)}function Yg(i,e){i.uniform2uiv(this.addr,e)}function qg(i,e){i.uniform3uiv(this.addr,e)}function jg(i,e){i.uniform4uiv(this.addr,e)}function $g(i,e,t){const n=this.cache,r=e.length,s=_o(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Ut(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||Qu,s[a])}function Kg(i,e,t){const n=this.cache,r=e.length,s=_o(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Ut(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||nd,s[a])}function Zg(i,e,t){const n=this.cache,r=e.length,s=_o(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Ut(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||id,s[a])}function Jg(i,e,t){const n=this.cache,r=e.length,s=_o(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Ut(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||td,s[a])}function Qg(i){switch(i){case 5126:return Ug;case 35664:return Ng;case 35665:return Fg;case 35666:return Og;case 35674:return Bg;case 35675:return zg;case 35676:return Hg;case 5124:case 35670:return Gg;case 35667:case 35671:return Vg;case 35668:case 35672:return kg;case 35669:case 35673:return Wg;case 5125:return Xg;case 36294:return Yg;case 36295:return qg;case 36296:return jg;case 35678:case 36198:case 36298:case 36306:case 35682:return $g;case 35679:case 36299:case 36307:return Kg;case 35680:case 36300:case 36308:case 36293:return Zg;case 36289:case 36303:case 36311:case 36292:return Jg}}class e_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ig(t.type)}}class t_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Qg(t.type)}}class n_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ia=/(\w+)(\])?(\[|\.)?/g;function wc(i,e){i.seq.push(e),i.map[e.id]=e}function i_(i,e,t){const n=i.name,r=n.length;for(ia.lastIndex=0;;){const s=ia.exec(n),a=ia.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){wc(t,c===void 0?new e_(o,i,e):new t_(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new n_(o),wc(t,d)),t=d}}}class Gs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);i_(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Rc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const r_=37297;let s_=0;function o_(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function a_(i){const e=ot.getPrimaries(ot.workingColorSpace),t=ot.getPrimaries(i);let n;switch(e===t?n="":e===Js&&t===Zs?n="LinearDisplayP3ToLinearSRGB":e===Zs&&t===Js&&(n="LinearSRGBToLinearDisplayP3"),i){case Kn:case mo:return[n,"LinearTransferOETF"];case Pt:case $a:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Cc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+o_(i.getShaderSource(e),a)}else return r}function l_(i,e){const t=a_(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function c_(i,e){let t;switch(e){case vh:t="Linear";break;case Mh:t="Reinhard";break;case Sh:t="OptimizedCineon";break;case Ru:t="ACESFilmic";break;case yh:t="AgX";break;case Eh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function u_(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(mr).join(`
`)}function d_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(mr).join(`
`)}function h_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function f_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function mr(i){return i!==""}function Lc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Pc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const p_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pa(i){return i.replace(p_,g_)}const m_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function g_(i,e){let t=ke[e];if(t===void 0){const n=m_.get(e);if(n!==void 0)t=ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Pa(t)}const __=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Dc(i){return i.replace(__,x_)}function x_(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ic(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function v_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Au?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===qd?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Xn&&(e="SHADOWMAP_TYPE_VSM"),e}function M_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Er:case yr:e="ENVMAP_TYPE_CUBE";break;case po:e="ENVMAP_TYPE_CUBE_UV";break}return e}function S_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case yr:e="ENVMAP_MODE_REFRACTION";break}return e}function E_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case wu:e="ENVMAP_BLENDING_MULTIPLY";break;case _h:e="ENVMAP_BLENDING_MIX";break;case xh:e="ENVMAP_BLENDING_ADD";break}return e}function y_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function b_(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=v_(t),c=M_(t),u=S_(t),d=E_(t),h=y_(t),m=t.isWebGL2?"":u_(t),g=d_(t),_=h_(s),p=r.createProgram();let f,y,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `}function Dn(){if(!zs)return;const i=[...Pe>0?[{idx:-1,label:wr,dimension:yi||G.N,visible:In}]:[],...ge.map((s,a)=>({idx:a,label:s.label,dimension:s.originalN,visible:s.visible}))];zs.textContent="";const e=document.createElement("h4");e.textContent="Objects",zs.appendChild(e);const t=document.createElement("table"),n=document.createElement("thead");n.innerHTML='<tr><th></th><th aria-label="Object name"></th><th>Dim</th></tr>',t.appendChild(n);const r=document.createElement("tbody");i.forEach(s=>{const a=document.createElement("tr");a.className=`object-row${s.idx===We?" active":""}${s.visible?"":" hidden"}`,a.addEventListener("click",()=>Ti(s.idx));const o=document.createElement("td"),l=document.createElement("button");l.className="object-eye",l.type="button",l.title=s.visible?"Hide object":"Show object",l.setAttribute("aria-label",s.visible?`Hide ${s.label}`:`Show ${s.label}`),l.innerHTML=zx(s.visible),l.addEventListener("click",h=>{h.stopPropagation(),Ox(s.idx,!s.visible)}),o.appendChild(l);const c=document.createElement("td"),u=document.createElement("input");u.className="object-name",u.value=s.label,u.title="Rename object",u.addEventListener("click",h=>h.stopPropagation()),u.addEventListener("keydown",h=>{h.stopPropagation(),h.key==="Enter"?(h.preventDefault(),u.blur()):h.key==="Escape"&&(u.value=s.label,u.blur())}),u.addEventListener("blur",()=>Bx(s.idx,u.value)),c.appendChild(u);const d=document.createElement("td");d.textContent=`${s.dimension}`,a.append(o,c,d),r.appendChild(a)}),t.appendChild(r),zs.appendChild(t),ss()}function Hx(i){return`#${Math.max(0,Math.min(16777215,i>>>0)).toString(16).padStart(6,"0")}`}function Ad(i){if(i===an)return Pe>0?{surface:Jn,renderer:Le}:null;const e=ge[i];return e?{surface:e.surface,renderer:e.renderer}:null}function Gx(i){Zt&&(Zt.disabled=!i),tn&&(tn.disabled=!i),nn&&(nn.disabled=!i),rn&&(rn.disabled=!i)}function wd(i){!Zt||!tn||!nn||!rn||(Ba=!0,Zt.value=Hx(i.color),tn.value=`${i.metalness}`,nn.value=`${i.roughness}`,rn.value=`${i.alpha}`,io&&(io.textContent=Zt.value),ro&&(ro.textContent=i.metalness.toFixed(3)),so&&(so.textContent=i.roughness.toFixed(3)),oo&&(oo.textContent=i.alpha.toFixed(3)),Ba=!1)}function Vx(){if(!jr||_r)return;const i=new el({canvas:jr,antialias:!0,alpha:!0});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.outputColorSpace=Pt,i.toneMapping=rt.toneMapping,i.toneMappingExposure=rt.toneMappingExposure,i.useLegacyLights=rt.useLegacyLights,i.setClearColor(0,0);const e=new tl;e.environment=je.environment;const t=new sn(36,1,.1,10);t.position.set(1.8,1.35,1.9),t.lookAt(0,0,0);const n=new to({color:fn.color,metalness:fn.metalness,roughness:fn.roughness,transparent:!1,opacity:fn.alpha,envMapIntensity:1.8,side:Rn}),r=new ct(new Yi(1,1,1),n);r.rotation.set(.45,.68,0),e.add(r);const s=new od(16777215,ao.intensity);s.position.copy(ao.position);const a=new ad(16777215,gd.intensity),o=new rd(qs.color.getHex(),qs.groundColor.getHex(),qs.intensity);e.add(a,o,s),_r=i,za=e,Wr=t,Ha=r}function Wa(i){if(Vx(),!_r||!za||!Wr||!Ha||!jr)return;const e=Math.max(1,jr.clientWidth),t=Math.max(1,jr.clientHeight);if(_r.setSize(e,t,!1),Wr.aspect=e/t,Wr.updateProjectionMatrix(),!i){_r.clear();return}const n=Ha.material;n.color.setHex(i.color),n.metalness=i.metalness,n.roughness=i.roughness,n.transparent=i.alpha<.999,n.opacity=i.alpha,n.depthWrite=!n.transparent,n.needsUpdate=!0,_r.render(za,Wr)}function Eo(){if(!Ys)return;const i=Ad(We),e=!!i;Ys.classList.toggle("empty",!i),Ys.classList.toggle("disabled",!e),Gx(e),i?(wd(i.surface),Wa(i.surface)):Wa(null)}function ai(i){if(Ba)return;const e=Ad(We);if(!e||!Zt||!tn||!nn||!rn)return;const t=ol({color:Number.parseInt(Zt.value.replace("#",""),16),metalness:Number.parseFloat(tn.value),roughness:Number.parseFloat(nn.value),alpha:Number.parseFloat(rn.value)}),n=e.surface;if(n.color!==t.color||Math.abs(n.metalness-t.metalness)>1e-6||Math.abs(n.roughness-t.roughness)>1e-6||Math.abs(n.alpha-t.alpha)>1e-6){if(i&&Qn(),We===an)Jn=t,Le.setSurface(Jn),Le.refreshSurface();else{const s=ge[We];if(!s)return;s.surface=t,s.renderer.setSurface(s.surface),s.renderer.refreshSurface()}wd(t),Wa(t)}}function kx(){Ys&&(Zt==null||Zt.addEventListener("input",()=>{io&&Zt&&(io.textContent=Zt.value),ai(!1)}),tn==null||tn.addEventListener("input",()=>{ro&&tn&&(ro.textContent=Number.parseFloat(tn.value).toFixed(3)),ai(!1)}),nn==null||nn.addEventListener("input",()=>{so&&nn&&(so.textContent=Number.parseFloat(nn.value).toFixed(3)),ai(!1)}),rn==null||rn.addEventListener("input",()=>{oo&&rn&&(oo.textContent=Number.parseFloat(rn.value).toFixed(3)),ai(!1)}),Zt==null||Zt.addEventListener("change",()=>ai(!0)),tn==null||tn.addEventListener("change",()=>ai(!0)),nn==null||nn.addEventListener("change",()=>ai(!0)),rn==null||rn.addEventListener("change",()=>ai(!0)))}function Wx(){const i=rl.geometry.getAttribute("color");if(!i)return;const e=new Xe(on[G.axesX%on.length]),t=new Xe(on[G.axesY%on.length]),n=new Xe(on[G.axesZ%on.length]);i.setXYZ(0,e.r,e.g,e.b),i.setXYZ(1,e.r,e.g,e.b),i.setXYZ(2,t.r,t.g,t.b),i.setXYZ(3,t.r,t.g,t.b),i.setXYZ(4,n.r,n.g,n.b),i.setXYZ(5,n.r,n.g,n.b),i.needsUpdate=!0}function qn(i){return["X","Y","Z","W","V","U","T","S"][i]??`D${i}`}function ss(){if(Wx(),!bu)return;const i=Ht(),e=Array.from({length:i}).map((t,n)=>`<span class="badge" style="background:${on[n%on.length]};">${qn(n)}</span>`).join("");bu.innerHTML=`<h4 style="margin:0 0 6px 0; font-size:12px; color:#e6ecf5;">Axes</h4><div>${e}</div>`}function os(){if(!kr)return;const i=Ht();if(i<1){kr.innerHTML="";return}const e=Lt.slice(0,i),t=new Set([e[(vt+0)%i],e[(vt+1)%i],e[(vt+2)%i]]),n=e.map((s,a)=>{const o=on[s%on.length],l=t.has(s);return`<li draggable="true" data-idx="${a}" class="${l?"active":""}" style="--axis-color:${o};border-top:3px solid ${o};">${qn(s)}</li>`}).join("");kr.innerHTML=`
    ...
    <ul>${n}</ul>
  `;const r=kr.querySelector("#axis-cycle-button");r==null||r.addEventListener("click",()=>yd(1)),kr.querySelectorAll("li").forEach(s=>{s.addEventListener("dragstart",a=>{var o;(o=a.dataTransfer)==null||o.setData("text/plain",s.dataset.idx||"")}),s.addEventListener("dragover",a=>a.preventDefault()),s.addEventListener("drop",a=>{var d;a.preventDefault();const o=Number(((d=a.dataTransfer)==null?void 0:d.getData("text/plain"))??-1),l=Number(s.dataset.idx??-1);if(o<0||l<0||o===l)return;const c=Lt.splice(o,1)[0];Lt.splice(l,0,c);const u=Lt.slice(0,Ht()).indexOf(G.axesX);vt=u>=0?u:0,Ed({x:Lt[vt%Ht()],y:Lt[(vt+1)%Ht()],z:Lt[(vt+2)%Ht()]}),os()})})}function Ti(i){let e=i;e===an&&Pe<=0&&(e=pi),e>=0&&!ge[e]&&(e=pi),e<pi&&(e=pi),We=e,Fn=-1,On=!1,Dn(),Tt&&(je.remove(Tt),Tt=null);const t=n=>{const r=new ki({color:16754253,transparent:!0,opacity:1,depthTest:!1,depthWrite:!1}),s=new xo(n,r);return s.renderOrder=10,s};if(e===an)Pe>0&&(Tt=t(Le.line.geometry));else if(e>=0){const n=ge[e];Tt=t(n.renderer.line.geometry)}Tt&&!G.editMode&&bi(e)&&je.add(Tt),rs(G.editMode),ft&&(je.remove(ft),ft=null),xt&&(je.remove(xt),xt=null),G.editMode&&bi(e)&&yo(e),Eo(),bo()}function Rr(){if(Tt){if(G.editMode||!bi(We)){je.remove(Tt),Tt=null;return}je.children.includes(Tt)||je.add(Tt)}}function co(){Fi&&(je.remove(Fi),Fi.geometry.dispose(),Fi=null),Oi&&(je.remove(Oi),Oi.geometry.dispose(),Oi=null)}function Xa(i,e){if(!e)return new w;let t=0,n=0,r=0;for(let s=0;s<e;s++){const a=s*3;t+=i[a],n+=i[a+1],r+=i[a+2]}return new w(t/e,n/e,r/e)}function Rd(i,e,t){const n=i===-1?null:ge[i],r=n?n.X:Gt,s=n?n.M:Pe,a=n?n.Y:fi,o=n?n.transform:Rt,l=n?n.originalN:yi||Ht(),c=n?n.axisMap:Dr;if(e<0||e>=s)return!1;const u=n?n.renderer.positions:Le.positions,d=e*3;xu.set(o.rot.x,o.rot.y,o.rot.z),_u.setFromEuler(xu),xa.compose(Ux,_u,o.scale),vu.copy(xa).invert(),Mu.set(u[d],u[d+1],u[d+2]),Su.set(a[e],a[s+e],a[2*s+e]),yu.copy(Su).applyMatrix4(xa),Eu.copy(Mu).sub(yu),Di.copy(t).sub(Eu).applyMatrix4(vu);const h=Mi.matrix;for(let x=0;x<ze;x++){let b=0;for(let P=0;P<ze;P++)b+=h[x*ze+P]*r[P*s+e];gu[x]=b,Bs[x]=b}const m=[G.axesX%ze,G.axesY%ze,G.axesZ%ze].map(x=>Math.max(0,Math.min(ze-1,x))),g=cl(l,c),_=.6;let p=g>=0?gu[g]??0:0;const f=g>=0?m.indexOf(g):-1;if(f>=0){const x=f===0?Di.x:f===1?Di.y:Di.z,b=1+_*x;Math.abs(b)>1e-6&&(p=x/b)}const y=g>=0?1/Math.max(.05,1-_*p):1;for(let x=0;x<3;x++){const b=m[x],P=x===0?Di.x:x===1?Di.y:Di.z;g>=0&&b===g?Bs[b]=p:Bs[b]=P/y}for(let x=0;x<ze;x++){let b=0;for(let P=0;P<ze;P++)b+=h[P*ze+x]*Bs[P];r[x*s+e]=b}return!0}function uo(){if(co(),D.mode==="none")return;const i=D.lockAxis!==-1,e=i?D.lockAxis:0,t=new w(e===0?1:0,e===1?1:0,e===2?1:0);if(!i&&!D.wPlane)return;let n=new w;if(D.targetVertex>=0){const a=D.instIdx===-1?null:ge[D.instIdx],o=a?a.renderer.positions:Le.positions,l=D.targetVertex*3;n.set(o[l],o[l+1],o[l+2])}else if(D.instIdx===-1&&Pe>0)n=Xa(Le.positions,Pe);else if(D.instIdx>=0){const a=ge[D.instIdx];n=Xa(a.renderer.positions,a.M)}const r=3,s=[n.clone().addScaledVector(t,-r),n.clone().addScaledVector(t,r)];if(i){const a=new jt().setFromPoints(s),o=new ki({color:16754253,linewidth:2,depthTest:!1,transparent:!0,opacity:.9});Fi=new Da(a,o),Fi.renderOrder=30,je.add(Fi)}if(D.wPlane){const a=new w(0,0,0);a.copy(t).cross(it.getWorldDirection(mt).normalize()).normalize(),a.lengthSq()===0&&a.copy(it.up).normalize();const o=2,l=[n.clone().addScaledVector(a,-o),n.clone().addScaledVector(a,o)],c=new jt().setFromPoints(l),u=new ki({color:12616956,linewidth:2,depthTest:!1,transparent:!0,opacity:.9});Oi=new Da(c,u),Oi.renderOrder=31,je.add(Oi)}}function yo(i){if(!G.editMode||!bi(i)){xt&&(je.remove(xt),xt=null),ft&&(je.remove(ft),ft=null);return}const e=i===-1?Le:ge[i].renderer,t=i===-1?Pe:ge[i].M;if(!e||t<=0)return;xt&&(je.remove(xt),xt=null);const n=new ns({color:12568533});xt=new Q_(_d,n,t);const r=new Dt,s=e.positions;for(let a=0;a<t;a++){const o=a*3;r.position.set(s[o],s[o+1],s[o+2]),r.updateMatrix(),xt.setMatrixAt(a,r.matrix)}xt.instanceMatrix.needsUpdate=!0,xt.renderOrder=5,je.add(xt),Fn>=0&&Ya(i,Fn)}function Ya(i,e){if(!bi(i))return;if(!ft){const s=new ns({color:16754253,depthTest:!1});ft=new ct(_d,s),ft.renderOrder=20}ft.scale.setScalar(1.35);const n=(i===-1?Le:ge[i].renderer).positions,r=e*3;ft.position.set(n[r],n[r+1],n[r+2]),je.add(ft)}function Cd(){if(We<0)return;Qn(),ge[We].renderer.dispose(),ge.splice(We,1),We=pi,Tt&&(je.remove(Tt),Tt=null),On=!1,ln(),gn(),Dn(),Ti(We)}const ge=[];function Xx(i){const e=new is(je);e.build(i.M,i.E);const t=ol(i.surface);return e.setSurface(t),e.setMode(G.renderMode),{renderer:e,Y:new Float32Array(3*i.M),X:new Float32Array(i.X),E:new Uint32Array(i.E),M:i.M,offset:i.offset.clone(),label:i.label,kind:i.kind,transform:Va(i.transform),originalN:i.originalN,axisMap:Md(i.axisMap,i.originalN),visible:i.visible,surface:t}}const Le=new is(je);Pe>0&&(Le.build(Pe,Ar),Le.setMode("wireframe"));const G={N:4,primitive:"hypercube",projection:"Canonical",sliceDim:-1,sliceMin:-.5,sliceMax:.5,renderMode:"wireframe",editMode:!1,autoSpin:!1,axesX:0,axesY:1,axesZ:2};wx();const Yx=i=>({...i,_lastTheta:i._lastTheta??0}),qx=[{i:0,j:1,theta:0,auto:!0,speed:.45},{i:2,j:3,theta:0,auto:!0,speed:.31},{i:4,j:5,theta:0,auto:!0,speed:.18}],dl=qx.map(Yx);function jx(){dl.forEach(i=>{i.i=Math.min(i.i,ze-1),i.j=Math.min(i.j,ze-1),i.theta=0,i._lastTheta=0})}function es(){su&&(su.textContent=`${G.N}D`),Yr&&(Yr.disabled=G.N<=3),qr&&(qr.disabled=G.N>=Ot)}function ho(i){if(!Number.isFinite(i)){es();return}const e=Math.max(3,Math.min(Ot,Math.round(i)));G.N=e;const t=Ht();vt=(vt%t+t)%t;const n=Lt.slice(0,t);G.axesX=n[vt%t]??0,G.axesY=n[(vt+1)%t]??1,G.axesZ=n[(vt+2)%t]??2,es(),os(),ss()}function Ld(){Mr&&(Mr.classList.toggle("active",G.editMode),Mr.setAttribute("aria-pressed",String(G.editMode)))}function Pd(i){G.editMode=i,rs(G.editMode),Ld(),Fn=-1,ft&&(je.remove(ft),ft=null),G.editMode?yo(We):xt&&(je.remove(xt),xt=null),Rr(),bo()}function bo(){const i=[{mode:"move",el:ks},{mode:"rotate",el:Ws},{mode:"scale",el:Xs}],e=bi(We),t=D.mode!=="none";for(const n of i)n.el&&(n.el.classList.toggle("active",D.mode===n.mode),n.el.disabled=!e||t)}function $x(){{const i=Ht(),e=[G.axesX%i,G.axesY%i,G.axesZ%i].map(n=>Math.max(0,Math.min(i-1,n))),t=new Float32Array(3*ze);t[0*ze+e[0]]=1,t[1*ze+e[1]]=1,t[2*ze+e[2]]=1,Zn.setCustomP(t)}}function gn(){Pe>0&&Le.geometry&&Le.filterEdgesByDimRange(Gt,ze,Pe,G.sliceDim,G.sliceMin,G.sliceMax),ge.forEach(i=>{i.renderer.filterEdgesByDimRange(i.X,ze,i.M,G.sliceDim,G.sliceMin,G.sliceMax)}),Rr(),rs(G.editMode),G.editMode?yo(We):xt&&(je.remove(xt),xt=null)}function Ma(i,e){if(e===0)return mu.set(0,0,0);let t=0,n=0,r=0;for(let l=0;l<e;l++)t+=i[l],n+=i[e+l],r+=i[2*e+l];const s=t/e,a=n/e,o=r/e;for(let l=0;l<e;l++)i[l]-=s,i[e+l]-=a,i[2*e+l]-=o;return mu.set(s,a,o)}function ln(){if(ze>=4){const e=[G.axesX%ze,G.axesY%ze,G.axesZ%ze].map(r=>Math.max(0,Math.min(ze-1,r))),t=.6,n=(r,s,a,o,l,c,u)=>{if(s===0)return;const d=ze,h=Mi.matrix,m=cl(c,u);for(let p=0;p<s;p++){for(let x=0;x<d;x++){let b=0;for(let P=0;P<d;P++)b+=h[x*d+P]*r[P*s+p];Vr[x]=b}const f=m>=0?Vr[m]??0:0,y=m>=0?1/Math.max(.05,1-t*f):1;a[0*s+p]=Vr[e[0]]*y,a[1*s+p]=Vr[e[1]]*y,a[2*s+p]=Vr[e[2]]*y}const g=Ma(a,s),_=mt.set(o.pos.x+g.x,o.pos.y+g.y,o.pos.z+g.z);l.setTransform(_,new Pn(o.rot.x,o.rot.y,o.rot.z),o.scale),l.writeInterleavedFrom(a),l.refreshSurface()};Pe>0&&Le.geometry&&n(Gt,Pe,fi,Rt,Le,yi||Ht(),Dr),ge.forEach(r=>{n(r.X,r.M,r.Y,r.transform,r.renderer,r.originalN,r.axisMap)})}else{if($x(),Pe>0&&Le.geometry){Zn.project(Gt,Pe,fi);const e=Ma(fi,Pe),t=mt.set(Rt.pos.x+e.x,Rt.pos.y+e.y,Rt.pos.z+e.z);Le.setTransform(t,new Pn(Rt.rot.x,Rt.rot.y,Rt.rot.z),Rt.scale),Le.writeInterleavedFrom(fi),Le.refreshSurface()}ge.forEach(e=>{Zn.project(e.X,e.M,e.Y);const t=Ma(e.Y,e.M),n=mt.set(e.transform.pos.x+t.x,e.transform.pos.y+t.y,e.transform.pos.z+t.z);e.renderer.setTransform(n,new Pn(e.transform.rot.x,e.transform.rot.y,e.transform.rot.z),e.transform.scale),e.renderer.writeInterleavedFrom(e.Y),e.renderer.refreshSurface()})}Td(),Rr(),G.editMode&&yo(We),uo()}function Dd(){if(!li)return;const i=G.autoSpin;li.classList.toggle("active",i),li.setAttribute("aria-pressed",String(i)),li.setAttribute("aria-label",i?"Stop auto rotation":"Start auto rotation"),li.title=i?"Stop auto rotation":"Start auto rotation"}function Kx(){Mi.reset(),dl.forEach(i=>{i.theta=0,i._lastTheta=0})}function Id(i){const e=G.autoSpin;G.autoSpin=i,e&&!i&&(Kx(),ln(),gn()),Dd()}function Zx(i){if(!G.autoSpin)return;const e=Ht();for(const t of dl){if(!t.auto||t.speed===0||t.i===t.j||t.i>=e||t.j>=e)continue;const n=t.speed*i;t.theta+=n,Mi.applyGivensLeft(t.i,t.j,n)}}function Ud(i){if(!et)return;On=!0,et.innerHTML="";const e=document.createElement("div");e.textContent="Delete?",e.style.padding="8px 12px",e.style.fontWeight="700",et.appendChild(e);const t=document.createElement("button");t.textContent="Confirm",t.onclick=()=>{et.style.display="none",On=!1,Cd()};const n=document.createElement("button");n.textContent="Cancel",n.onclick=()=>{On=!1,et.style.display="none"},et.appendChild(t),et.appendChild(n);const r=(i==null?void 0:i.clientX)??hn.x,s=(i==null?void 0:i.clientY)??hn.y;et.style.left=`${r}px`,et.style.top=`${s}px`,et.style.display="block"}function Jx(){ge.forEach(i=>i.renderer.dispose()),ge.length=0,We=pi}function Qx(i,e=!0){e&&Qn();let t;if(Pe>0&&In)t={verts:new Float32Array(Gt),edges:new Uint32Array(Ar),V:Pe,kind:G.primitive,axisMap:[...Dr],originalN:yi||G.N};else{const l=il(G.primitive,G.N),c=ll(G.N);t={verts:So(l.verts,G.N,c),edges:l.edges,V:l.V,kind:G.primitive,axisMap:c,originalN:G.N}}const n=new is(je);n.build(t.V,t.edges);const r=Pe>0&&In?Ei(Jn):Ei(fn);n.setSurface(r);const s=new Float32Array(3*t.V),a=`${t.kind} #${ge.length+1}`,o={pos:i.clone(),rot:new w,scale:new w(1,1,1)};ge.push({renderer:n,Y:s,X:t.verts,E:t.edges,M:t.V,offset:i.clone(),label:a,kind:t.kind,transform:o,originalN:t.originalN,axisMap:[...t.axisMap],visible:!0,surface:r}),Zn.project(t.verts,t.V,s),n.setTransform(o.pos,new Pn(o.rot.x,o.rot.y,o.rot.z),o.scale),n.writeInterleavedFrom(s),n.filterEdgesByDimRange(t.verts,Ot,t.V,G.sliceDim,G.sliceMin,G.sliceMax),n.setMode(G.renderMode),ln(),gn(),Si&&Si(G.renderMode),Dn()}function Nd(i,e,t,n,r,s){var l;Id(!1),Ct.active=!1,Mt.enableZoom=!0,Mt.enablePan=!0,Mt.enableRotate=!0,Mt.enabled=!0,Mt.reset(),it.position.set(2.6,1.8,2.6);const a=G.renderMode;xd=n;const o=Ot;ze=o,G.N=Math.min(G.N,Ot),Gt=new Float32Array(e),Ar=t.length?new Uint32Array(t):vd,Pe=Math.floor(e.length/o),Mi=new ld(o),Zn=new cd(o,Mi.matrix,no(o)),fi=new Float32Array(3*Pe),Jx(),In=!0,Rt.pos.set(0,0,0),Rt.rot.set(0,0,0),Rt.scale.set(1,1,1),yi=r??Ht(),Dr=Md(s,yi),Jn=Ei(fn),Lt=Array.from({length:ze},(c,u)=>u),vt=0,G.axesX=Lt[0]??0,G.axesY=Lt[1]??1,G.axesZ=Lt[2]??2,jx(),G.sliceDim>=o&&(G.sliceDim=o-1),Pe>0?(Le.build(Pe,Ar),Le.setSurface(Jn),Le.setMode(G.renderMode),Si&&Si(a),ln(),gn()):(l=Le.dispose)==null||l.call(Le),es(),wr=n==="custom"?"Custom":"Hypercube",Dn(),Ti(an),ss(),os()}function e0(i,e,t="text/plain"){const n=new Blob([e],{type:t}),r=URL.createObjectURL(n),s=document.createElement("a");s.href=r,s.download=i,s.click(),URL.revokeObjectURL(r)}async function t0(i){try{const e=await i.text(),t=gx(e);if(t.N<3||t.N>8){alert("Only datasets between 3 and 8 dimensions can be visualized.");return}Qn(),G.N=t.N;const n=al(t.N),r=So(t.X,t.N,n),s=t.edges.length?t.edges:vd;Nd(Ot,r,s,"custom",t.N,n)}catch(e){console.error(e),alert(`Import failed: ${e.message}`)}finally{xi&&(xi.value="")}}function n0(){const{Xsrc:i,count:e,Esrc:t}=i0();if(e===0){alert("No data to export");return}e0("data.json",_x(i,e,ze,t),"application/json")}function i0(){if(We>=0&&ge[We]){const i=ge[We];return{Xsrc:i.X,count:i.M,Esrc:i.E}}return Pe>0?{Xsrc:Gt,count:Pe,Esrc:Ar}:{Xsrc:new Float32Array,count:0,Esrc:new Uint32Array}}function r0(i,e,t,n){const r=[];for(let s=0;s<i;s++){const a=e[s*t+n];r.push(`d${s}: ${a.toFixed(3)}`)}return r}function Fd(i){const e=rt.domElement.getBoundingClientRect();return hi.set((i.clientX-e.left)/e.width*2-1,-((i.clientY-e.top)/e.height)*2+1),du.setFromNormalAndCoplanarPoint(it.getWorldDirection(mt).normalize(),Mt.target),di.setFromCamera(hi,it),di.ray.intersectPlane(du,hu)?hu.clone():Mt.target.clone()}function s0(i){if(!Yn)return;const e=rt.domElement.getBoundingClientRect(),t=i.clientX-e.left,n=i.clientY-e.top,r=e.width,s=e.height;let a=-1,o=Number.POSITIVE_INFINITY;const l=(d,h,m,g,_)=>{mt.set(d,h,m).project(it);const p=(mt.x*.5+.5)*r,f=(-mt.y*.5+.5)*s,y=p-t,x=f-n,b=y*y+x*x;b<o&&(o=b,a=g,c=_)};let c=-1;if(In)for(let d=0;d<Pe;d++){const h=d*3;l(Le.positions[h],Le.positions[h+1],Le.positions[h+2],d,-1)}ge.forEach((d,h)=>{if(!d.visible)return;const m=d.renderer.positions;for(let g=0;g<d.M;g++){const _=g*3;l(m[_],m[_+1],m[_+2],g,h)}});const u=30*30;if(a>=0&&o<u){const d=c>=0&&ge[c]?{coords:ge[c].X,count:ge[c].M}:{coords:Gt,count:Pe},h=r0(ze,d.coords,d.count,a);Yn.innerHTML=`<div style="font-weight:600;margin-bottom:4px;">v${a}</div><div>${h.join("<br>")}</div>`,Yn.style.left=`${i.clientX}px`,Yn.style.top=`${i.clientY}px`,Yn.classList.add("visible")}else Yn.classList.remove("visible");if($n&&D.mode==="none"){const d=(i.clientX-e.left)/e.width*2-1,h=-((i.clientY-e.top)/e.height)*2+1;$n.textContent=`Cursor NDC: (${d.toFixed(3)}, ${h.toFixed(3)})`}}ln();gn();ss();os();Dn();rs(G.editMode);es();Ld();kx();Eo();if(ru){const i=Array.from(ru.querySelectorAll("button")),e=n=>ux.includes(n),t=()=>{i.forEach(n=>n.classList.toggle("active",n.dataset.mode===G.renderMode))};Si=n=>{G.renderMode=n,Le.setMode(n),Le.refreshSurface(),ge.forEach(r=>{r.renderer.setMode(n),r.renderer.refreshSurface()}),Eo(),t()},i.forEach(n=>{n.addEventListener("click",()=>{e(n.dataset.mode)&&Si(n.dataset.mode)})}),t()}Pe===0&&ge.length===0&&(Qx(new w(0,0,0),!1),Ti(0));xi&&xi.addEventListener("change",()=>{var e;const i=(e=xi.files)==null?void 0:e[0];i&&t0(i)});pa==null||pa.addEventListener("click",()=>xi==null?void 0:xi.click());ma==null||ma.addEventListener("click",()=>n0());Mr==null||Mr.addEventListener("click",()=>Pd(!G.editMode));ks==null||ks.addEventListener("click",()=>ul("move"));Ws==null||Ws.addEventListener("click",()=>ul("rotate"));Xs==null||Xs.addEventListener("click",()=>ul("scale"));Yr==null||Yr.addEventListener("click",()=>ho(G.N-1));qr==null||qr.addEventListener("click",()=>ho(G.N+1));ga==null||ga.addEventListener("keydown",i=>{i.stopPropagation(),i.key==="ArrowDown"||i.key==="ArrowLeft"||i.key==="-"||i.key==="_"?(i.preventDefault(),ho(G.N-1)):(i.key==="ArrowUp"||i.key==="ArrowRight"||i.key==="+"||i.key==="=")&&(i.preventDefault(),ho(G.N+1))});li==null||li.addEventListener("click",()=>Id(!G.autoSpin));Dd();bo();const o0=new ix;rt.domElement.addEventListener("pointermove",s0);rt.domElement.addEventListener("pointermove",i=>{if(hn={x:i.clientX,y:i.clientY},D.mode==="none")return;i.preventDefault();const e=i.clientX-D.startMouse.x,t=i.clientY-D.startMouse.y;if(D.targetVertex>=0){const n=D.instIdx===-1?null:ge[D.instIdx];n?n.renderer.positions:Le.positions;const r=D.targetVertex*3,s=rt.domElement.getBoundingClientRect();hi.set((i.clientX-s.left)/s.width*2-1,-((i.clientY-s.top)/s.height)*2+1),di.setFromCamera(hi,it),D.plane.setFromNormalAndCoplanarPoint(it.getWorldDirection(mt).normalize(),D.planeHitStart);const a=di.ray.intersectPlane(D.plane,mt);if(!a)return;const o=Oa;if(D.mode==="move"){const c=D.lockAxis;o.set(c===1||c===2?D.vertexStart.x:a.x,c===0||c===2?D.vertexStart.y:a.y,c===0||c===1?D.vertexStart.z:a.z),D.lastHit.copy(o)}else if(D.mode==="scale"){const c=a.clone().sub(D.planeHitStart),u=D.vertexStart.clone().sub(D.planeHitStart),d=u.length(),h=c.length(),m=d>1e-6?h/d:1,g=u.multiplyScalar(m).add(D.planeHitStart);o.copy(g),D.lastHit.copy(g)}else if(D.mode==="rotate"){const c=D.vertexStart.clone().sub(D.planeHitStart),u=a.clone().sub(D.planeHitStart),d=Math.atan2(u.y,u.x)-Math.atan2(c.y,c.x),h=new Bn().setFromAxisAngle(D.axis,d);c.applyQuaternion(h).add(D.planeHitStart),o.copy(c),D.lastHit.copy(c)}else return;if(!Rd(D.instIdx,D.targetVertex,o))return;ln(),gn();const l=n?n.renderer.positions:Le.positions;ft&&ft.position.set(l[r],l[r+1],l[r+2]),$n&&($n.textContent=`Vertex (${D.targetVertex}): (${l[r].toFixed(3)}, ${l[r+1].toFixed(3)}, ${l[r+2].toFixed(3)})`)}else{const n=D.instIdx===-1?Rt:ge[D.instIdx].transform;if(D.mode==="move"){const r=D.instIdx===-1?Gt:ge[D.instIdx].X,s=D.objectDataStart,a=D.instIdx===-1?Pe:ge[D.instIdx].M;if(s&&a>0){const o=rt.domElement.getBoundingClientRect();hi.set((i.clientX-o.left)/o.width*2-1,-((i.clientY-o.top)/o.height)*2+1),di.setFromCamera(hi,it);const l=di.ray.intersectPlane(D.plane,mt);if(!l)return;const c=l.clone().add(D.moveOffset).sub(D.planeHitStart);D.lockAxis===0?(c.y=0,c.z=0):D.lockAxis===1?(c.x=0,c.z=0):D.lockAxis===2&&(c.x=0,c.y=0);const u=[G.axesX,G.axesY,G.axesZ];for(let d=0;d<a;d++)for(let h=0;h<3;h++){const g=u[h]%ze*a+d;r[g]=s[g]+c.getComponent(h)}D.lastHit.copy(l)}}else if(D.mode==="rotate")if(D.wPlane&&D.objectDataStart){const r=D.instIdx===-1?null:ge[D.instIdx],s=r?r.X:Gt,a=D.objectDataStart,o=r?r.M:Pe;if(o>0){const l=r?r.originalN:yi||Ht(),c=r?r.axisMap:Dr,u=cl(l,c),d=Sd(D.lockAxis,u);if(d<0||u<0||d===u)return;const h=(e-t)*.01,m=Math.cos(h),g=Math.sin(h);for(let _=0;_<o;_++){const p=a[d*o+_],f=a[u*o+_];s[d*o+_]=p*m-f*g,s[u*o+_]=p*g+f*m}}}else{const r=e*.005,s=t*.005,a=D.startRot.x,o=D.startRot.y,l=D.startRot.z;D.lockAxis===0?n.rot.set(a+s,o,l):D.lockAxis===1?n.rot.set(a,o+r,l):D.lockAxis===2?n.rot.set(a,o,l+r):n.rot.set(a+s,o+r,l)}else if(D.mode==="scale"){const r=(e-t)*.005,s=Math.max(.1,Math.min(5,D.startScale+r));n.scale.set(s,s,s)}$n&&($n.textContent=`Object: pos(${n.pos.x.toFixed(3)}, ${n.pos.y.toFixed(3)}, ${n.pos.z.toFixed(3)}) rot(${n.rot.x.toFixed(3)}, ${n.rot.y.toFixed(3)}, ${n.rot.z.toFixed(3)})`)}ln(),gn(),Rr(),uo()});rt.domElement.addEventListener("pointerleave",()=>Yn==null?void 0:Yn.classList.remove("visible"));rt.domElement.addEventListener("contextmenu",i=>{if(!et)return;i.preventDefault(),hn={x:i.clientX,y:i.clientY},On=!1,et.innerHTML="";const e=Fd(i);if(G.editMode){if(Fn<0)return;[{label:"Move vertex",mode:"move"}].forEach(s=>{const a=document.createElement("button");a.textContent=s.label,a.onclick=()=>{et.style.display="none",fo(s.mode,i)},et.appendChild(a)})}else We===an&&Pe>0||We>=0?[{label:"Move",mode:"move"},{label:"Rotate",mode:"rotate"},{label:"Scale",mode:"scale"},{label:"Delete",onClick:()=>Ud(i)}].forEach(a=>{const o=document.createElement("button");o.textContent=a.label,o.onclick=()=>{if(et.style.display="none",a.onClick){a.onClick();return}fo(a.mode,i)},et.appendChild(o)}):[{label:"Hypercube",kind:"hypercube"},{label:"Cross polytope",kind:"cross"},{label:"Simplex",kind:"simplex"},{label:"Simplex prism",kind:"simplexPrism"}].forEach(a=>{const o=document.createElement("button");o.textContent=`Add ${a.label}`,o.onclick=()=>{et.style.display="none",Qn();const l=il(a.kind,G.N),c=ll(G.N),u=So(l.verts,G.N,c),d=new is(je);d.build(l.V,l.edges),Sr.copy(e);const h=new Float32Array(3*l.V),m=`${a.label} #${ge.length+1}`,g={pos:Sr.clone(),rot:new w,scale:new w(1,1,1)},_=Ei(fn);d.setSurface(_),ge.push({renderer:d,Y:h,X:u,E:l.edges,M:l.V,offset:Sr.clone(),label:m,kind:a.kind,transform:g,originalN:G.N,axisMap:c,visible:!0,surface:_}),Zn.project(u,l.V,h),d.setTransform(g.pos,new Pn(g.rot.x,g.rot.y,g.rot.z),g.scale),d.writeInterleavedFrom(h),d.filterEdgesByDimRange(u,Ot,l.V,G.sliceDim,G.sliceMin,G.sliceMax),d.setMode(G.renderMode),ln(),gn(),Si&&Si(G.renderMode),Dn()},et.appendChild(o)});const t=Math.min(i.clientX,window.innerWidth-180),n=Math.min(i.clientY,window.innerHeight-150);et.style.left=`${t}px`,et.style.top=`${n}px`,et.style.display=et.innerHTML?"block":"none"});window.addEventListener("click",()=>{On||(et&&(et.style.display="none"),On=!1)});rt.domElement.addEventListener("wheel",i=>{if(!G.editMode)return;i.preventDefault();const e=i.deltaY>0?1:-1;let t=G.sliceDim+e;t=Math.max(-1,Math.min(ze-1,t)),G.sliceDim=t,gn()});rt.domElement.addEventListener("mousedown",i=>{if(i.button===1){i.preventDefault(),i.stopPropagation(),Ct.active=!0,Ct.lastX=i.clientX,Ct.accum=0,Ct.prevZoom=Mt.enableZoom,Ct.prevPan=Mt.enablePan,Mt.enableZoom=!1,Mt.enablePan=!1;return}},{capture:!0});rt.domElement.addEventListener("pointerdown",i=>{if(Ct.active)return;if(hn={x:i.clientX,y:i.clientY},D.mode!=="none"){if(i.button===0){if(Qn(),D.startMouse.set(i.clientX,i.clientY),D.targetVertex>=0&&(D.planeHitStart.copy(D.vertexStart),D.plane.setFromNormalAndCoplanarPoint(it.getWorldDirection(mt).normalize(),D.planeHitStart)),D.targetVertex>=0){const u=D.instIdx,d=u===-1?null:ge[u],h=d?d.renderer.positions:Le.positions,m=D.targetVertex*3;Oa.set(h[m],h[m+1],h[m+2]),Rd(D.instIdx,D.targetVertex,Oa)}if(D.mode="none",D.vertexDataStart=null,D.lockAxis=-1,co(),ln(),gn(),G.editMode&&Fn>=0&&Ya(We,Fn),Rr(),$n)if(D.targetVertex>=0){const u=D.instIdx===-1?null:ge[D.instIdx],d=u?u.renderer.positions:Le.positions,h=D.targetVertex*3;$n.textContent=`Vertex (${D.targetVertex}) commit: (${d[h].toFixed(3)}, ${d[h+1].toFixed(3)}, ${d[h+2].toFixed(3)})`}else{const u=D.instIdx===-1?Rt:ge[D.instIdx].transform;$n.textContent=`Object commit: pos(${u.pos.x.toFixed(3)}, ${u.pos.y.toFixed(3)}, ${u.pos.z.toFixed(3)})`}}else if(i.button===2){if(D.targetVertex>=0){const u=D.instIdx===-1?null:ge[D.instIdx],d=u?u.renderer.positions:Le.positions,h=D.targetVertex*3;d[h]=D.vertexStart.x,d[h+1]=D.vertexStart.y,d[h+2]=D.vertexStart.z;const m=u?u.renderer:Le;if(D.vertexDataStart){const g=u?u.X:Gt,_=u?u.M:Pe;for(let p=0;p<ze;p++)g[p*_+D.targetVertex]=D.vertexDataStart[p]}u?(Zn.project(u.X,u.M,u.Y),u.renderer.writeInterleavedFrom(u.Y),u.renderer.filterEdgesByDimRange(u.X,ze,u.M,G.sliceDim,G.sliceMin,G.sliceMax)):(Zn.project(Gt,Pe,fi),Le.writeInterleavedFrom(fi),Le.filterEdgesByDimRange(Gt,ze,Pe,G.sliceDim,G.sliceMin,G.sliceMax)),m.geometry.getAttribute("position").needsUpdate=!0,m.geometry.computeBoundingBox(),m.geometry.computeBoundingSphere(),ft&&ft.position.set(d[h],d[h+1],d[h+2])}else{const u=D.instIdx===-1?Rt:ge[D.instIdx].transform;D.objectDataStart&&(D.instIdx===-1?Gt:ge[D.instIdx].X).set(D.objectDataStart),u.pos.copy(D.startPos),u.rot.copy(D.startRot),u.scale.set(D.startScale,D.startScale,D.startScale)}D.mode="none",D.vertexDataStart=null,D.lockAxis=-1,D.objectDataStart=null,co(),D.moveOffset.set(0,0,0),ln(),gn(),Rr()}i.preventDefault();return}if(i.button!==0)return;const e=rt.domElement.getBoundingClientRect(),t=i.clientX-e.left,n=i.clientY-e.top,r=e.width,s=e.height,a=(u,d)=>{let h=1/0,m=1/0,g=-1/0,_=-1/0;for(let p=0;p<d;p++){const f=p*3;mt.set(u[f],u[f+1],u[f+2]).project(it);const y=(mt.x*.5+.5)*r,x=(-mt.y*.5+.5)*s;y<h&&(h=y),y>g&&(g=y),x<m&&(m=x),x>_&&(_=x)}return{minX:h,maxX:g,minY:m,maxY:_}},o=[];if(Pe>0){const u=a(Le.positions,Pe),d=t>=u.minX&&t<=u.maxX&&n>=u.minY&&n<=u.maxY,h=(u.maxX-u.minX)*(u.maxY-u.minY);o.push({instIdx:-1,contains:d,area:h,nearestDist2:Number.POSITIVE_INFINITY})}ge.forEach((u,d)=>{if(!u.visible)return;const h=a(u.renderer.positions,u.M),m=t>=h.minX&&t<=h.maxX&&n>=h.minY&&n<=h.maxY,g=(h.maxX-h.minX)*(h.maxY-h.minY);o.push({instIdx:d,contains:m,area:g,nearestDist2:Number.POSITIVE_INFINITY})});let l=-1;const c=o.filter(u=>u.contains&&isFinite(u.area));if(c.length)c.sort((u,d)=>u.area-d.area),l=c[0].instIdx;else{let u=Number.POSITIVE_INFINITY;const d=(m,g,_,p)=>{mt.set(m,g,_).project(it);const f=(mt.x*.5+.5)*r,y=(-mt.y*.5+.5)*s,x=f-t,b=y-n,P=x*x+b*b;P<u&&(u=P,l=p)};if(In)for(let m=0;m<Pe;m++){const g=m*3;d(Le.positions[g],Le.positions[g+1],Le.positions[g+2],-1)}ge.forEach((m,g)=>{if(!m.visible)return;const _=m.renderer.positions;for(let p=0;p<m.M;p++){const f=p*3;d(_[f],_[f+1],_[f+2],g)}});const h=35*35;u>=h&&(l=-999)}if(l!==-999){if(Ti(l),G.editMode&&i.button===0){const d=(l===-1?Le:ge[l].renderer).positions;let h=-1,m=Number.POSITIVE_INFINITY;const g=l===-1?Pe:ge[l].M;for(let _=0;_<g;_++){const p=_*3;mt.set(d[p],d[p+1],d[p+2]).project(it);const f=(mt.x*.5+.5)*r,y=(-mt.y*.5+.5)*s,x=f-t,b=y-n,P=x*x+b*b;P<m&&(m=P,h=_)}Fn=h,Ya(l,h)}}else Ti(pi),Fn=-1,ft&&(je.remove(ft),ft=null),Tt&&(je.remove(Tt),Tt=null)});window.addEventListener("pointermove",i=>{if(!Ct.active)return;i.preventDefault();const e=i.clientX-Ct.lastX;Ct.lastX=i.clientX,Ct.accum+=e;const t=35;let n=0;for(;Ct.accum>t;)n++,Ct.accum-=t;for(;Ct.accum<-t;)n--,Ct.accum+=t;n!==0&&yd(n)});window.addEventListener("pointerup",i=>{i.button!==1||!Ct.active||(Ct.active=!1,Ct.accum=0,Mt.enableZoom=Ct.prevZoom,Mt.enablePan=Ct.prevPan)});window.addEventListener("keydown",i=>{const e=i.key.toLowerCase();if(!(i.ctrlKey||i.metaKey))return;const n=e==="z"&&!i.shiftKey,r=e==="y"||e==="z"&&i.shiftKey;if(!(!n&&!r)&&!Fx(i.target)&&D.mode==="none"){if(i.preventDefault(),n){const s=$r.pop();s&&(Ga.push(ka()),Tu(s))}else if(r){const s=Ga.pop();s&&($r.push(ka()),Tu(s))}}});window.addEventListener("keydown",i=>{if(bd(i.target)||D.mode==="none")return;const e=i.key.toLowerCase();if(e==="w"){D.mode==="rotate"&&(i.preventDefault(),D.wPlane=!D.wPlane,uo());return}(e==="x"||e==="y"||e==="z")&&(D.lockAxis=e==="x"?0:e==="y"?1:2,uo())});window.addEventListener("keydown",i=>{if(!bd(i.target)&&(i.key==="Tab"&&(i.preventDefault(),Pd(!G.editMode)),D.mode==="none")){if(i.key==="g"||i.key==="r"||i.key==="s"){i.preventDefault();const e={g:"move",r:"rotate",s:"scale"},t=new PointerEvent("pointerdown",{clientX:hn.x,clientY:hn.y});fo(e[i.key],t)}else if(i.key.toLowerCase()==="a"&&i.shiftKey){if(i.preventDefault(),!et)return;et.innerHTML="";const e=[{label:"Hypercube",kind:"hypercube"},{label:"Cross polytope",kind:"cross"},{label:"Simplex",kind:"simplex"},{label:"Simplex prism",kind:"simplexPrism"}],t=Fd(new PointerEvent("pointerdown",{clientX:hn.x,clientY:hn.y}));e.forEach(n=>{const r=document.createElement("button");r.textContent=`Add ${n.label}`,r.onclick=()=>{et.style.display="none",Qn();const s=il(n.kind,G.N),a=ll(G.N),o=So(s.verts,G.N,a),l=new is(je);l.build(s.V,s.edges),Sr.copy(t);const c=new Float32Array(3*s.V),u=`${n.label} #${ge.length+1}`,d={pos:Sr.clone(),rot:new w,scale:new w(1,1,1)},h=Ei(fn);l.setSurface(h),ge.push({renderer:l,Y:c,X:o,E:s.edges,M:s.V,offset:Sr.clone(),label:u,kind:n.kind,transform:d,originalN:G.N,axisMap:a,visible:!0,surface:h}),Zn.project(o,s.V,c),l.setTransform(d.pos,new Pn(d.rot.x,d.rot.y,d.rot.z),d.scale),l.writeInterleavedFrom(c),l.filterEdgesByDimRange(o,Ot,s.V,G.sliceDim,G.sliceMin,G.sliceMax),l.setMode(G.renderMode),ln(),gn(),Dn()},et.appendChild(r)}),et.style.left=`${hn.x}px`,et.style.top=`${hn.y}px`,et.style.display="block"}else if(i.key==="x"){if(i.preventDefault(),!(We===an&&Pe>0||We>=0))return;On?(On=!1,et&&(et.style.display="none"),Cd()):Ud()}}});function Od(){const i=Math.min(o0.getDelta(),.05);Zx(i),ln(),Mt.update(),bo(),Mo(),rt.render(je,it),requestAnimationFrame(Od)}Od();function fo(i,e){var t;if(bi(We))if(D.mode=i,D.instIdx=We,D.targetVertex=G.editMode?Fn:-1,D.startMouse.set(e.clientX,e.clientY),D.targetVertex>=0){if(D.targetVertex<0){D.mode="none";return}const n=D.instIdx===-1?null:ge[D.instIdx],r=n?n.renderer.positions:Le.positions,s=D.targetVertex*3;D.vertexStart.set(r[s],r[s+1],r[s+2]);const a=n?n.X:Gt;D.vertexDataStart=new Float32Array(ze);for(let o=0;o<ze;o++)D.vertexDataStart[o]=a[o*(n?n.M:Pe)+D.targetVertex];D.startScale=1,D.plane.setFromNormalAndCoplanarPoint(it.getWorldDirection(mt).normalize(),D.vertexStart),D.planeHitStart.copy(D.vertexStart),D.lastHit.copy(D.vertexStart),D.lockAxis=-1,D.wPlane=!1}else{const n=We===an?Rt:(t=ge[We])==null?void 0:t.transform;if(!n)return;if(D.startPos.copy(n.pos),D.startRot.copy(n.rot),D.startScale=n.scale.x,D.lockAxis=-1,D.wPlane=!1,i==="move"||i==="rotate"){const r=We===an?Gt:ge[We].X,s=We===an?Pe:ge[We].M;if(D.objectDataStart=new Float32Array(r.length),D.objectDataStart.set(r),D.lastHit.set(0,0,0),i==="move"){const a=We===an?Le.positions:ge[We].renderer.positions,o=Xa(a,s);D.planeHitStart.copy(o),D.plane.setFromNormalAndCoplanarPoint(it.getWorldDirection(mt).normalize(),o);const l=rt.domElement.getBoundingClientRect();hi.set((e.clientX-l.left)/l.width*2-1,-((e.clientY-l.top)/l.height)*2+1),di.setFromCamera(hi,it);const c=di.ray.intersectPlane(D.plane,mt);c?(D.lastHit.copy(c),D.moveOffset.copy(D.planeHitStart).sub(c)):(D.lastHit.copy(o),D.moveOffset.set(0,0,0))}}else D.objectDataStart=null}}window.addEventListener("resize",()=>{const i=window.innerWidth,e=window.innerHeight;it.aspect=i/e,it.updateProjectionMatrix(),rt.setSize(i,e),Eo()});
